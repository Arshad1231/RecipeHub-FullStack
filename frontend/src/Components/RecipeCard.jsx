...
const RecipeCard = ({ EachRecipe }) => {
  ...
  return (
    <div className="bg-[#FFF9F4] border border-[#E6D3C6] rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex overflow-hidden max-w-3xl mx-auto my-4">
      ...
      <div className="flex flex-col items-center flex-shrink-0 w-32 m-4 gap-3">
        ...
        <Link
          ...
          className="inline-block bg-[#F6A700] hover:bg-[#E59400] text-white font-semibold py-2 px-4 rounded-lg transition-all duration-300 shadow-md text-center"
        >
          See Details
        </Link>
      </div>
      ...
      <div className="flex flex-col justify-start p-4 flex-1">
        ...
        <h2 className="text-2xl font-bold text-[#3E2723] mb-2 flex items-center gap-2">
          <FaUtensils className="text-[#F6A700]" />
          {EachRecipe.RecipeName}
        </h2>

        
        <div className="text-[#7C5E48] text-sm space-y-1 mb-2">
